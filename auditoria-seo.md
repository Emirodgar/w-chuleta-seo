...
Es recomendable utilizar las siguientes herramientas para asegurarnos de que ofrecemos una experiencia correcta:

 - [Google Mobile Friendly Tool](https://search.google.com/test/mobile-friendly)
 - [GTMetrix](https://gtmetrix.com/)
 
 ## Evitar el contenido duplicado
 
Nuestra página puede ser accedida de múltiples formas por lo que tenemos que asegurarnos de que únicamente facilitamos una de ellas. Por ejemplo, los siguientes accesos podrían mostrar la misma página:
 ...
 Si no las redireccionamos correctamente, para Google serán páginas distintas.
